...
`Launcher3`, `Launcher3QuickStep`, `NexusLauncherRelease`, `ParanoidQuickStep`, `PixelLauncher`, `Trebuchet` and `TrebuchetQuickStep` packages are overriden from `priv-app/Lawnchair/Android.mk`.
